...
우선 롬복이 필요한데 여기서 어노테이션 프로세서가 중요합니다.  
...
위에서 잠깐 언급했던 어노테이션 프로세서가 여기서 등장합니다.

![image](https://user-images.githubusercontent.com/40778768/232312800-85bc8ee1-f2e0-4515-a67c-608b70970d1e.png)

어노테이션 프로세서는 컴파일 시점에 어노테이션을 분석하고 새로운 코드를 생성하는 컴파일러 플러그인입니다.        
또 롬복만이 아니라 JPA, QueryDSL 등 다양한 라이브러리에서 어노테이션 프로세서를 이용하여 기능을 제공하는 것을 확인할 수 있습니다.     

그럼 롬복은 컴파일 시점에서 AST를 분석하고 조작해서 새로운 코드를 작성해준다는 것인데 어떻게 이를 가능하게 하는걸까요?
